...
/**
 * Appends a single turn to a conversation the caller can write to. Used by
 * the voice UI to persist every spoken turn the moment it is transcribed
 * (voice-continuity fix, 2026-07-19) — the transcript lives in Postgres
 * before the audio finishes playing, so a dropped call loses nothing.
 */
